 ...
 * @author guest1Day
 */
public class DB_challenge7 extends HttpServlet {
    ...
    public void DB_challenge7(PrintWriter out,HttpServletRequest request, HttpServletResponse response){
        //変数を宣言
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DB_challenge7 at " + request.getContextPath() + "</h1>");
            
            DB_challenge7(out,request,response);
