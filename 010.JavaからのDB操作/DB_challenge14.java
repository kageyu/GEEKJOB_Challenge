 ...
 * @author guest1Day
 */
public class DB_challenge14 extends HttpServlet {

    //セッションを削除するメソッドを作成
    public void DB_challenge14(HttpServletRequest request){
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>DB_challenge14</title>");            
            out.println("</head>");
            out.println("<body>");
            
            //セッションを削除
            DB_challenge14(request);
            //処理を戻します
