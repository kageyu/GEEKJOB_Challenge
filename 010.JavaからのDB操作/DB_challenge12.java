 ...
 * @author guest1Day
 */
public class DB_challenge12 extends HttpServlet {
    ...
    //課題内容をメソッド内に記述
     public void DB_challenge12(PrintWriter out,HttpServletRequest request, HttpServletResponse response){
        //変数を宣言
        ...
        try{
            ...
            //データを追加
            db_st = db_con.prepareStatement("INSERT INTO ItemTable VALUES (?,?)");
            db_st.setInt(1,id);
            db_st.setString(2,name);
            db_st.executeUpdate();
            
            //確認表示
            db_st = db_con.prepareStatement("SELECT * FROM ItemTable WHERE itemID = ?");
            db_st.setInt(1,id);
            db_data = db_st.executeQuery();
            db_data.next();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DB_challenge12(out,request,response);
